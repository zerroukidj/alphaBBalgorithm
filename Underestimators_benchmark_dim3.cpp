...
double fx(double x[5]) {
    double f;
    //f17
        f = (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4)) + (4 * pow(x[2], 2) - (2.1) * pow(x[2], 4) + (1 / 6) * pow(x[2], 6) + x[2] * x[3] - 4 * pow(x[3], 2) + 4 * pow(x[3], 4));
       return f;
}
...
double myfunc3(unsigned n, const double* x, double* grad, void* my_func_data)
{
     ...
     */
    if (grad) {
        grad[0] = pow(x[0], 5) - (42 * pow(x[0], 3)) / 5 + 8 * x[0] - alpha[jk[0]][1] * (-2 * x[0] + xp[jk[0]][1].upper() + xp[jk[0]][1].lower()) - betaik(xp, alpha, 1, jk[0], Ni);
        grad[1] = pow(x[1], 5) + (38 * pow(x[1], 3)) / 5 + x[0] + x[2] - alpha[jk[1]][2] * (-2 * x[1] + xp[jk[1]][2].upper() + xp[jk[1]][2].lower()) - betaik(xp, alpha, 2, jk[1], Ni);
        grad[2] = 16 * pow(x[2], 3) - 8 * x[2] + x[1] - alpha[jk[2]][3] * (-2 * x[2] + xp[jk[2]][3].upper() + xp[jk[2]][3].lower()) - betaik(xp, alpha, 1, jk[2], Ni);
    }
    for (int i = 1; i <= n; i++) {
    ...
    return  (4 * pow(x[0], 2) - (2.1) * pow(x[0], 4) + (1 / 6) * pow(x[0], 6) + x[0] * x[1] - 4 * pow(x[1], 2) + 4 * pow(x[1], 4)) + (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4)) - (0.5) * sum;
}
double myfunc4(unsigned n, const double* x, double* grad, void* my_func_data)
{
    if (grad) {
        grad[0] = pow(x[0], 5) - (42 * pow(x[0], 3)) / 5 + 8 * x[0] - (sigma[1] * ((1 / ((xg[1].upper() - xg[1].lower()) * (((x[0] - xg[1].lower()) / (xg[1].upper() - xg[1].lower())) + 1)) - 1 / ((xg[1].upper() - xg[1].lower()) * (((xg[1].upper() - x[0]) / (xg[1].upper() - xg[1].lower())) + 1))) / log(2)));
        grad[1] = pow(x[1], 5) + (38 * pow(x[1], 3)) / 5 + x[0] + x[2] - (sigma[2] * ((1 / ((xg[2].upper() - xg[2].lower()) * (((x[1] - xg[2].lower()) / (xg[2].upper() - xg[2].lower())) + 1)) - 1 / ((xg[2].upper() - xg[2].lower()) * (((xg[2].upper() - x[1]) / (xg[2].upper() - xg[2].lower())) + 1))) / log(2)));
        grad[2] = 16 * pow(x[2], 3) - 8 * x[2] + x[1] - (sigma[3] * ((1 / ((xg[3].upper() - xg[3].lower()) * (((x[2] - xg[3].lower()) / (xg[3].upper() - xg[3].lower())) + 1)) - 1 / ((xg[3].upper() - xg[3].lower()) * (((xg[3].upper() - x[2]) / (xg[3].upper() - xg[3].lower())) + 1))) / log(2)));
    }
    return (4 * pow(x[0], 2) - (2.1) * pow(x[0], 4) + (1 / 6) * pow(x[0], 6) + x[0] * x[1] - 4 * pow(x[1], 2) + 4 * pow(x[1], 4)) + (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4)) - (sigma[1] * (((log(((x[0] - xg[1].lower()) / (xg[1].upper() - xg[1].lower())) + 1) + log(((xg[1].upper() - x[0]) / (xg[1].upper() - xg[1].lower())) + 1)) / log(2)) - 1)) - (sigma[2] * (((log(((x[1] - xg[2].lower()) / (xg[2].upper() - xg[2].lower())) + 1) + log(((xg[2].upper() - x[1]) / (xg[2].upper() - xg[2].lower())) + 1)) / log(2)) - 1)) - (sigma[3] * (((log(((x[2] - xg[3].lower()) / (xg[3].upper() - xg[3].lower())) + 1) + log(((xg[3].upper() - x[2]) / (xg[3].upper() - xg[3].lower())) + 1)) / log(2)) - 1));
}
// interval xg
double myfunc5(unsigned n, const double* x, double* grad, void* my_func_data)
{
    if (grad) {
        grad[0] = pow(x[0], 5) - (42 * pow(x[0], 3)) / 5 + 8 * x[0] - (-gamma[1] * exp(gamma[1] * (x[0] - xg[1].lower())) + gamma[1] * exp(gamma[1] * (xg[1].upper() - x[0])));
        grad[1] = pow(x[1], 5) + (38 * pow(x[1], 3)) / 5 + x[0] + x[2] - (-gamma[2] * exp(gamma[2] * (x[1] - xg[2].lower())) + gamma[2] * exp(gamma[2] * (xg[2].upper() - x[1])));
        grad[2] = 16 * pow(x[2], 3) - 8 * x[2] + x[1] - (-gamma[3] * exp(gamma[3] * (x[2] - xg[3].lower())) + gamma[3] * exp(gamma[3] * (xg[3].upper() - x[2])));
    }
    return (4 * pow(x[0], 2) - (2.1) * pow(x[0], 4) + (1 / 6) * pow(x[0], 6) + x[0] * x[1] - 4 * pow(x[1], 2) + 4 * pow(x[1], 4)) + (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4)) - (1 - exp(gamma[1] * (x[0] - xg[1].lower())) * (1 - exp(gamma[1] * (xg[1].upper() - x[0])))) - (1 - exp(gamma[2] * (x[1] - xg[2].lower())) * (1 - exp(gamma[2] * (xg[2].upper() - x[1])))) - (1 - exp(gamma[3] * (x[2] - xg[3].lower())) * (1 - exp(gamma[3] * (xg[3].upper() - x[2]))));
}
// interval xg
double myfunc1(unsigned n, const double* x, double* grad, void* my_func_data)
{
    if (grad) {
        grad[0] = pow(x[0], 5) - (42 * pow(x[0], 3)) / 5 + 8 * x[0] + k[1] * (-xg[1].upper() - xg[1].lower() + 2 * x[0]);
    ...
    return (4 * pow(x[0], 2) - (2.1) * pow(x[0], 4) + (1 / 6) * pow(x[0], 6) + x[0] * x[1] - 4 * pow(x[1], 2) + 4 * pow(x[1], 4)) + (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4)) - (0.5) * ((k[1] * ((xg[1].upper() - x[0]) * (x[0] - xg[1].lower()))) + (k[2] * ((xg[2].upper() - x[1]) * (x[1] - xg[2].lower()))) + (k[3] * ((xg[3].upper() - x[2]) * (x[2] - xg[3].lower()))));
}
...
double myfunc2(unsigned n, const double* x, double* grad, void* my_func_data)
{
    ...
    return  (4 * pow(x[0], 2) - (2.1) * pow(x[0], 4) + (1 / 6) * pow(x[0], 6) + x[0] * x[1] - 4 * pow(x[1], 2) + 4 * pow(x[1], 4)) + (4 * pow(x[1], 2) - (2.1) * pow(x[1], 4) + (1 / 6) * pow(x[1], 6) + x[1] * x[2] - 4 * pow(x[2], 2) + 4 * pow(x[2], 4));
